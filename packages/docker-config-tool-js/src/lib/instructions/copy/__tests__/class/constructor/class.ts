                ...
                describe(`class`, () => {
                    describe(`constructor`, () => {
                        describe(`base`, () => {
                            ...
                            test(`edge case - don't create a instruction with a minimum valid object with invalid from`, () => {
                                const copyParams: CopyInstructionParamObject = {
                                    sources: '.',
                                    destination: '.',
                            ...
                            test(`edge case - don't chown with an invalid parameter`, () => {
                                const testVal = 0
                            ...
                            test(`edge case - don't chmod with an invalid parameter`, () => {
                                const testVal = 0
                            ...
                            test(`edge case - don't link with an invalid parameter`, () => {
                                const testVal = 0
                            ...
                            test(`edge case - don't set parents with an invalid parameter`, () => {
                                const testVal = 0
                            ...
                            test(`edge case - don't add an exclude with an invalid parameter`, () => {
                                const testVal = 0
